package com.welmo.tools.dbhelper;
...
public class WelmoConfigs extends ContentProvider{

	public static final Uri CONTENT_URI = Uri.parse( "content://com.welemo.configuration"); 
	private Context mcontext;
	private WelmoConfigDB theDB = null;
	
	WelmoConfigs(Context ctx){
		mcontext = ctx;
	}
	...
	public boolean onCreate() {
		...
		theDB = new WelmoConfigDB(mcontext);
		return false;
	}
