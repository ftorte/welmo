...
public class MeetingDayViewToolBar extends ToolBar {
	...
	public MeetingDayViewToolBar(Context context, AttributeSet attrs,
		...
		//create 
        CreateImageButton(GO_MIN7,R.drawable.moin7b_16x16, 0, 3, 0, 0, R.drawable.background);
        CreateImageButton(GO_MIN1,R.drawable.moins1_16x16, 0, 3, 0, 0, R.drawable.background);
        dateLabel= CreateButton(DAYLABEL,"Test", 0, 3, 0, 0, R.drawable.background);
        CreateImageButton(GO_PLUS1,R.drawable.plus1_16x16, 0, 3, 0, 0, R.drawable.background);
        CreateImageButton(GO_PLUS7,R.drawable.plus7_16x16, 0, 3, 0, 0, R.drawable.background);
